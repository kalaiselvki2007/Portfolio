...
<head>
  ...
  <title>Kalai Selvi .K | Portfolio</title>
  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700&display=swap" rel="stylesheet">
  <!-- Font Awesome for icons/stickers -->
  ...
  <style>
    ...
    * {
    ...
    /* Home */
    #home {
      background: linear-gradient(to right, #8e2de2, #ff0080);
      color: white;
    }
...
<body>
  ...
  <section id="home">
    ...
    <h1>Hello, I'm Kalai Selvi .K,<br>A passionate Data Science student</h1>
  ...
  <!-- Footer -->
  <footer>
    <p>© 2025 Kalai Selvi .K | Made with 💜 in Violet & Pink theme</p>
  </footer>
